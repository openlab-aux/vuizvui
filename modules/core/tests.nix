...
let
  ...
  upstreamTests = lib.concatMap mkTest [
    ...
    (mkPrometheusExporterTest "apcupsd")
    (mkPrometheusExporterTest "artifactory")
    (mkPrometheusExporterTest "bind")
    (mkPrometheusExporterTest "bird")
    (mkPrometheusExporterTest "bitcoin")
    (mkPrometheusExporterTest "blackbox")
    (mkPrometheusExporterTest "borgmatic")
    (mkPrometheusExporterTest "collectd")
    (mkPrometheusExporterTest "deluge")
    (mkPrometheusExporterTest "dnsmasq")
    (mkPrometheusExporterTest "dnssec")
    (mkPrometheusExporterTest "domain")
    (mkPrometheusExporterTest "dovecot")
    (mkPrometheusExporterTest "exportarr-sonarr")
    (mkPrometheusExporterTest "fastly")
    (mkPrometheusExporterTest "fritzbox")
    (mkPrometheusExporterTest "graphite")
    (mkPrometheusExporterTest "idrac")
    (mkPrometheusExporterTest "influxdb")
    (mkPrometheusExporterTest "ipmi")
    (mkPrometheusExporterTest "jitsi")
    (mkPrometheusExporterTest "json")
    (mkPrometheusExporterTest "keylight")
    (mkPrometheusExporterTest "knot")
    (mkPrometheusExporterTest "lnd")
    (mkPrometheusExporterTest "mail")
    (mkPrometheusExporterTest "mikrotik")
    (mkPrometheusExporterTest "modemmanager")
    (mkPrometheusExporterTest "mysqld")
    (mkPrometheusExporterTest "nextcloud")
    (mkPrometheusExporterTest "nginx")
    (mkPrometheusExporterTest "nginxlog")
    (mkPrometheusExporterTest "node")
    (mkPrometheusExporterTest "pgbouncer")
    (mkPrometheusExporterTest "php-fpm")
    (mkPrometheusExporterTest "ping")
    (mkPrometheusExporterTest "postfix")
    (mkPrometheusExporterTest "postgres")
    (mkPrometheusExporterTest "process")
    (mkPrometheusExporterTest "pve")
    ...
    (mkPrometheusExporterTest "smokeping")
    (mkPrometheusExporterTest "snmp")
    (mkPrometheusExporterTest "sql")
    (mkPrometheusExporterTest "statsd")
    (mkPrometheusExporterTest "surfboard")
    (mkPrometheusExporterTest "systemd")
    (mkPrometheusExporterTest "unbound")
    (mkPrometheusExporterTest "unpoller")
    (mkPrometheusExporterTest "v2ray")
    (mkPrometheusExporterTest "varnish")
    (mkPrometheusExporterTest "wireguard")
    (mkPrometheusExporterTest "zfs")
    ...
    { check = config.boot.supportedFilesystems.zfs or false
           && config.boot.zfs.package.version == pkgs.zfs_2_3.version;
      path  = ["nixos" "zfs" "series_2_3"];
    }
    { check = config.boot.supportedFilesystems.zfs or false
